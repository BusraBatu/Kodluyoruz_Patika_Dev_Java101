...
public class Student {
    ...
    public void verbalNotesOfAll(int matVerbal, int fizikVerbal, int kimyaVerbal){
    ...
    public void calcAvarage() {
        this.avarage =( (this.fizik.note*0.80)+(this.fizik.verbalNote*0.20) +
                (this.kimya.note*0.70)+(this.kimya.verbalNote*0.30) +(this.mat.note*0.90)+(this.mat.verbalNote*0.10)) / 3.0;
    }
